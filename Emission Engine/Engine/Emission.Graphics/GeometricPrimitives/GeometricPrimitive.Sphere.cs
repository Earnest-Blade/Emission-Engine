...
namespace Emission.Graphics.GeometricPrimitives
{
    ...
    {
        public static Model PrimitiveSphere(float radius, float rings, float segments) => PrimitiveSphere(radius, rings, segments, Array.Empty<Texture>());
        public static Model PrimitiveSphere(float radius, float rings, float segments, Texture[] textures)
        {
