...
namespace Emission.Window.GLFW
{
    ...
    public static class Glfw
    {
        ...
        public static ErrorCode GetError(out string description)
        {
            ...
            description = code == ErrorCode.None ? null : PtrToStringUtf8(ptr);
            return code;
        }
        ...
        public static string GetJoystickGuid(int joystickId)
        {
            ...
            return ptr == IntPtr.Zero ? null : PtrToStringUtf8(ptr);
        }
        ...
        ///     The current context.
        /// </value>
        public static IntPtr CurrentContext => GetCurrentContext();
        ...
        ///     The version string.
        /// </value>
        public static string VersionString => PtrToStringUtf8(GetVersionString());
        ...
        private static extern IntPtr CreateWindow(int width, int height, byte[] title, Monitor monitor, IntPtr share);
        ...
        public static extern PositionCallback SetWindowPositionCallback(IntPtr window,
        ...
        public static extern SizeCallback SetWindowSizeCallback(IntPtr window, SizeCallback sizeCallback);
        ...
        private static extern void SetWindowTitle(IntPtr window, byte[] title);
        ...
        public static extern FocusCallback SetWindowFocusCallback(IntPtr window, FocusCallback focusCallback);
        ...
        public static extern void SetWindowIcon(IntPtr window, int count, Icon[] images);
        ...
        public static extern WindowCallback SetCloseCallback(IntPtr window, WindowCallback closeCallback);
        ...
        public static extern Monitor GetWindowMonitor(IntPtr window);
        ...
        public static extern void SetWindowMonitor(IntPtr window, Monitor monitor, int x, int y, int width, int height,
            int refreshRate);
        ...
        private static extern void SetClipboardString(IntPtr window, byte[] bytes);
        ...
        public static extern FileDropCallback SetDropCallback(IntPtr window, FileDropCallback dropCallback);
        ...
        public static extern void SetCursor(IntPtr window, Cursor cursor);
        ...
        public static extern void GetCursorPosition(IntPtr window, out double x, out double y);
        ...
        public static extern void SetCursorPosition(IntPtr window, double x, double y);
        ...
        public static extern MouseCallback SetCursorPositionCallback(IntPtr window, MouseCallback mouseCallback);
        ...
        public static extern MouseEnterCallback SetCursorEnterCallback(IntPtr window, MouseEnterCallback mouseCallback);
        ...
        [return: MarshalAs(UnmanagedType.FunctionPtr, MarshalTypeRef = typeof(MouseCallback))]
        public static extern MouseCallback SetScrollCallback(IntPtr window, MouseCallback mouseCallback);
        ...
        public static extern InputState GetMouseButton(IntPtr window, MouseButton button);
        ...
        public static extern void SetWindowUserPointer(IntPtr window, IntPtr userPointer);
        ...
        public static extern CharCallback SetCharCallback(IntPtr window, CharCallback charCallback);
        ...
        public static extern CharModsCallback SetCharModsCallback(IntPtr window, CharModsCallback charCallback);
        ...
        [return: MarshalAs(UnmanagedType.FunctionPtr, MarshalTypeRef = typeof(WindowCallback))]
        public static extern WindowCallback SetWindowRefreshCallback(IntPtr window, WindowCallback callback);
        ...
        public static extern KeyCallback SetKeyCallback(IntPtr window, KeyCallback keyCallback);
        ...
        public static extern IconifyCallback SetWindowIconifyCallback(IntPtr window, IconifyCallback callback);
        ...
        private static extern int GetWindowAttribute(IntPtr window, int attribute);
        ...
        public static IntPtr CreateWindow(int width, int height, [NotNull] string title, Monitor monitor, IntPtr share)
        {
        ...
        public static ClientApi GetClientApi(IntPtr window)
        {
        ...
        {
            return PtrToStringUtf8(GetClipboardStringInternal(window));
        }
        ...
        public static ContextApi GetContextCreationApi(IntPtr window)
        {
        ...
        public static Version GetContextVersion(IntPtr window)
        {
        ...
        public static bool GetIsDebugContext(IntPtr window)
        {
        ...
        public static bool GetIsForwardCompatible(IntPtr window)
        {
        ...
        {
            return PtrToStringUtf8(GetJoystickNameInternal(joystick));
        }
        ...
        {
            return PtrToStringUtf8(GetKeyNameInternal(key, scanCode));
        }
        ...
        {
            return PtrToStringUtf8(GetMonitorNameInternal(monitor));
        }
        ...
        public static Profile GetProfile(IntPtr window)
        {
        ...
        public static Robustness GetRobustness(IntPtr window)
        {
        ...
        public static bool GetWindowAttribute(IntPtr window, WindowAttribute attribute)
        {
