...
namespace Emission.Toolbox.ImGuiTool
{
    /// <summary>
    /// Code from https://github.com/NogginBops/ImGui.NET_OpenTK_Sample
    /// </summary>
    public class ImGuiController : IDisposable
    {
        ...
        /// </summary>
        public ImGuiController(Vector2 windowSize)
        {
        ...
        public void WindowResized(Vector2 windowSize)
        {
            _windowWidth = (int)windowSize.X;
            _windowHeight = (int)windowSize.Y;
        }
        ...
        public void RecreateFontDeviceTexture()
        {
            ...
            int mips = (int)Mathf.Floor(System.Math.Log(Mathf.Max(width, height), 2));
        ...
        private void UpdateImGuiInput()
        {
            ...
            io.MouseDown[0] = Input.IsMouseButtonDown(MouseButton.Button1);
            io.MouseDown[1] = Input.IsMouseButtonDown(MouseButton.Button2);
            io.MouseDown[2] = Input.IsMouseButtonDown(MouseButton.Button3);
        ...
        private void RenderImDrawData(ImDrawDataPtr draw_data)
        {
            ...
            for (int i = 0; i < draw_data.CmdListsCount; i++)
            {
                ...
                if (vertexSize > _vertexBufferSize)
                {
                    ...
                    Debug.Log($"[INFO] Resize dear ImGui vertex buffer to new size {_vertexBufferSize}");
                }
