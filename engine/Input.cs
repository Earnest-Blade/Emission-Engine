...
namespace Emission
{
    class Input
    {
        ...
        {
            get => Current._mousePosition - Window.Singleton.WindowSize / 2;
        }
        ...
        {
            get => Current._lastMousePosition - Window.Singleton.WindowSize / 2;
        }
        ...
        public static Vector2 DeltaMousePositionCenter
        {
            get
            {
                ...
                return DeltaMousePosition - (Window.Singleton.WindowSize / 2);
            }
        }
        ...
        public virtual void FocusCallback(bool isFocus)
        {
            if (current == null) return;
            Current.ResetDelta();
        }
