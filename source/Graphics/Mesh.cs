...
namespace Emission.Graphics
{
    ...
    {
        public string Name => _meshData.Name;
        
        public PrimitiveType PrimitiveType => _meshData.PrimitiveType;
        ...
        {
            Vertices = new List<Vertex>(data.Vertices);
            Indices = new List<uint>(data.Indices);
            Textures = new TextureArray(data.Textures);
            Bones = new List<Bone>(data.Bones);
        ...
        public Mesh(List<Vertex> vertices, List<uint> indices, TextureArray textures)
        {
            Vertices = vertices;
            Indices = indices;
            Textures = textures;
        ...
        public Mesh(Vertex[] vertices, uint[] indices, TextureArray textures)
        {
        ...
        public void Draw(Shader shader)
        {
            ...
            {
                Textures[i].Use();
                shader.UseUniform1(Textures[i].Name, i);
            }
            ...
            glDrawElements((uint)PrimitiveType, Indices.Count, GL_UNSIGNED_INT, NULL);
