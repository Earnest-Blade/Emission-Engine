...
namespace Emission.Graphics.GeometricPrimitives
{
    public static partial class GeometricPrimitive
    {
        ...
        public static Model PrimitiveCube(Vector3 size) => PrimitiveCube(size, new TextureArray());
        public static Model PrimitiveCube(Vector3 size, Texture texture) => PrimitiveCube(size, new TextureArray(texture));
        public static Model PrimitiveCube(Vector3 size, TextureArray textures)
        {
