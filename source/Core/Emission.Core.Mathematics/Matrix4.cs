...
namespace Emission.Core.Mathematics
{
    ...
    public struct Matrix4 : IEquatable<Matrix4>
    {
        ...
        /*public Matrix4(Assimp.Matrix4x4 m)
        {
            Row0 = new Vector4(m.A1, m.A2, m.A3, m.A4);
            Row1 = new Vector4(m.B1, m.B2, m.B3, m.B4);
            Row2 = new Vector4(m.C1, m.C2, m.C3, m.C4);
            Row3 = new Vector4(m.D1, m.D2, m.D3, m.D4);
        }*/
        ...
        public static Matrix4 FromQuaternion(Quaternion quaternion)
        {
            ...
            float sx2 = quaternion.W * x2;
            float sy2 = quaternion.W * y2;
            float sz2 = quaternion.W * z2;
            
            return new Matrix4
            {
                Column0 = new Vector4(1 - (yy2 + zz2), xy2 + sz2, xz2 - sy2, 0),
                Column1 = new Vector4(xy2 - sz2, 1 - (xx2 + zz2), yz2 + sx2, 0),
                Column2 = new Vector4(xz2 + sy2, yz2 - sx2, 1 - (xx2 + yy2), 0),
                Column3 = Vector4.UnitW
            };         
        ...
        /// <param name="nearDepth">Near plane rendered.</param>
        /// <param name="farDepth">Far plane rendered.</param>
        /// <returns></returns>
        ...
        {
            return MathF.Abs(other!.M11 - M11) < MathHelper.EPSILON &&
                   MathF.Abs(other.M12 - M12) < MathHelper.EPSILON &&
                   MathF.Abs(other.M13 - M13) < MathHelper.EPSILON &&
                   MathF.Abs(other.M14 - M14) < MathHelper.EPSILON &&

                   MathF.Abs(other.M21 - M21) < MathHelper.EPSILON &&
                   MathF.Abs(other.M22 - M22) < MathHelper.EPSILON &&
                   MathF.Abs(other.M23 - M23) < MathHelper.EPSILON &&
                   MathF.Abs(other.M24 - M24) < MathHelper.EPSILON &&

                   MathF.Abs(other.M31 - M31) < MathHelper.EPSILON &&
                   MathF.Abs(other.M32 - M32) < MathHelper.EPSILON &&
                   MathF.Abs(other.M33 - M33) < MathHelper.EPSILON &&
                   MathF.Abs(other.M34 - M34) < MathHelper.EPSILON &&

                   MathF.Abs(other.M41 - M41) < MathHelper.EPSILON &&
                   MathF.Abs(other.M42 - M42) < MathHelper.EPSILON &&
                   MathF.Abs(other.M43 - M43) < MathHelper.EPSILON &&
                   MathF.Abs(other.M44 - M44) < MathHelper.EPSILON;
        }
