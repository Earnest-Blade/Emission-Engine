    ...
    public sealed unsafe class Window : IDisposable, IEngineBehaviour
    {
        ...
        public Window(WindowConfig config)
        {
            ...
            if (glfwInit() == 0)
            {
                ...
                throw new EmissionException(EmissionException.ERR_GLFW, error, true, true);
            }
            ...
            if (Handle == (void*)0) 
                throw new EmissionException(EmissionException.ERR_GLFW, "Failed to create GLFW Window!", false, true);
