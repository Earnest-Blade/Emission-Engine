...
namespace Emission
{
    public class Debug : TextWriter, IDisposable
    {
        ...
        /// </summary>
        public static string LogPath => GameInstance.HasInstance() ? GameInstance.Debugger._logPath : LOG_FILE_DEFAULT_PATH;
        ...
        {
            WriteLn(string.Join(ARRAY_SEPARATOR, obj.Cast<object>()));
        }
        ...
        /// </summary>
        /// <param name="array">Array to log.</param>
        public static void LogWarning(Array array) => LogWarning('[' + string.Join(ARRAY_SEPARATOR, array) + ']');
        ...
        public static void LogError(Array array, bool showTrace) => LogError('[' + string.Join(ARRAY_SEPARATOR, array) + ']', showTrace);
        ...
        /// <param name="str">Message to log.</param>
        /// <param name="showTrace">If log the stacktrace after the error message</param>
        public static void LogError(string str, bool showTrace) => LogError((object)str, showTrace);
        ...
        /// <param name="obj">Content to log.</param>
        /// <param name="showTrace">If log the stacktrace after the error message</param>
        public static void LogError(object? obj, bool showTrace)
        {
            ...
            if (showTrace)
            {
                ...
                WriteAssert(stackTrace, obj?.ToString());
            }
            else
        ...
        ///
        ///
        internal static void FatalError(string error, bool showTrace)
        {
            LogError(error, showTrace);
            ShowMessageBox(MESSAGE_BOX_TITLE, error, MB_ICONERROR | MB_OK | MB_DEFBUTTON1 | MB_TOPMOST);
            
            LogError("FATAL ERROR!", false);
            Environment.Exit(-1);
        }
