...
namespace Emission.Graphics
{
    public unsafe class Renderer
    {
        ...
        public void Initialize()
        {
            ...
            Debug.Log($"[INFO] Using GLSL {MemoryHelper.PtrToStringUtf8(glGetString(GL_SHADING_LANGUAGE_VERSION))}");
            Debug.Log($"[INFO] Running with OpenGL Vendor {MemoryHelper.PtrToStringUtf8(glGetString(GL_VENDOR))}");
            Debug.Log($"[INFO] Running with OpenGL Renderer {MemoryHelper.PtrToStringUtf8(glGetString(GL_RENDERER))}");
