...
{
    /// <summary>
    /// The base class the vast majority of the Emission.GLFW functions.
    /// </summary>
    ...
    public static unsafe class Glfw
    {
		...
		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		public delegate void PFNGLFWWINDOWPOSFUNPROC( long* window, int xpos, int ypos );
		
		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		public delegate void PFNGLFWWINDOWSIZEFUNPROC( long* window, int width, int height );
		
		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		public delegate void PFNGLFWWINDOWCLOSEFUNPROC( long* window );
		
		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		public delegate void PFNGLFWWINDOWREFRESHFUNPROC( long* window );
		
		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		public delegate void PFNGLFWWINDOWFOCUSFUNPROC( long* window, int focused );
		
		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		public delegate void PFNGLFWWINDOWICONIFYFUNPROC( long* window, int iconified );
		
		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		public delegate void PFNGLFWWINDOWMAXIMIZEFUNPROC( long* window, int maximized );
		
		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		public delegate void PFNGLFWFRAMEBUFFERSIZEFUNPROC( long* window, int width, int height );
		
		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		public delegate void PFNGLFWWINDOWCONTENTSCALEFUNPROC( long* window, float xscale, float yscale );
		
		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		public delegate void PFNGLFWMOUSEBUTTONFUNPROC( long* window, int button, int action, int mods );
		
		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		public delegate void PFNGLFWCURSORPOSFUNPROC( long* window, double xpos, double ypos );
		
		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		public delegate void PFNGLFWCURSORENTERFUNPROC( long* window, int entered );
		
		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		public delegate void PFNGLFWSCROLLFUNPROC( long* window, double xoffset, double yoffset );
		
		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		public delegate void PFNGLFWKEYFUNPROC( long* window, int key, int scancode, int action, int mods );
		
		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		public delegate void PFNGLFWCHARFUNPROC( long* window, uint codepoint );
		
		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		public delegate void PFNGLFWCHARMODSFUNPROC( long* window, uint codepoint, int mods );
		
		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		public delegate void PFNGLFWDROPFUNPROC( long* window, int count, byte*[] paths );
		...
		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		public delegate long* PFNGLFWCREATEWINDOWPROC( int width, int height, byte* title, Monitor* monitor, long* share );
		
		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		public delegate void PFNGLFWDESTROYWINDOWPROC( long* window );
		
		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		public delegate int PFNGLFWWINDOWSHOULDCLOSEPROC( long* window );
		
		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		public delegate void PFNGLFWSETWINDOWSHOULDCLOSEPROC( long* window, int value );
		
		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		public delegate void PFNGLFWSETWINDOWTITLEPROC( long* window, byte* title );
		
		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		public delegate void PFNGLFWSETWINDOWICONPROC( long* window, int count, Icon images );
		
		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		public delegate void PFNGLFWGETWINDOWPOSPROC( long* window, int* xpos, int* ypos );
		
		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		public delegate void PFNGLFWSETWINDOWPOSPROC( long* window, int xpos, int ypos );
		
		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		public delegate void PFNGLFWGETWINDOWSIZEPROC( long* window, int* width, int* height );
		
		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		public delegate void PFNGLFWSETWINDOWSIZELIMITSPROC( long* window, int minwidth, int minheight, int maxwidth, int maxheight );
		
		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		public delegate void PFNGLFWSETWINDOWASPECTRATIOPROC( long* window, int numer, int denom );
		
		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		public delegate void PFNGLFWSETWINDOWSIZEPROC( long* window, int width, int height );
		
		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		public delegate void PFNGLFWGETFRAMEBUFFERSIZEPROC( long* window, int* width, int* height );
		
		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		public delegate void PFNGLFWGETWINDOWFRAMESIZEPROC( long* window, int* left, int* top, int* right, int* bottom );
		
		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		public delegate void PFNGLFWGETWINDOWCONTENTSCALEPROC( long* window, float* xscale, float* yscale );
		
		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		public delegate float PFNGLFWGETWINDOWOPACITYPROC( long* window );
		
		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		public delegate void PFNGLFWSETWINDOWOPACITYPROC( long* window, float opacity );
		
		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		public delegate void PFNGLFWICONIFYWINDOWPROC( long* window );
		
		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		public delegate void PFNGLFWRESTOREWINDOWPROC( long* window );
		
		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		public delegate void PFNGLFWMAXIMIZEWINDOWPROC( long* window );
		
		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		public delegate void PFNGLFWSHOWWINDOWPROC( long* window );
		
		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		public delegate void PFNGLFWHIDEWINDOWPROC( long* window );
		
		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		public delegate void PFNGLFWFOCUSWINDOWPROC( long* window );
		
		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		public delegate void PFNGLFWREQUESTWINDOWATTENTIONPROC( long* window );
		
		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		public delegate Monitor* PFNGLFWGETWINDOWMONITORPROC( long* window );
		
		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		public delegate void PFNGLFWSETWINDOWMONITORPROC( long* window, Monitor* monitor, int xpos, int ypos, int width, int height, int refreshRate );
		
		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		public delegate int PFNGLFWGETWINDOWATTRIBPROC( long* window, int attrib );
		
		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		public delegate void PFNGLFWSETWINDOWATTRIBPROC( long* window, int attrib, int value );
		
		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		public delegate void PFNGLFWSETWINDOWUSERPOINTERPROC( long* window, void* pointer );
		
		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		public delegate void* PFNGLFWGETWINDOWUSERPOINTERPROC( long* window );
		
		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		[return: MarshalAs(UnmanagedType.FunctionPtr, MarshalTypeRef = typeof(PositionCallback))]
		public delegate PositionCallback PFNGLFWSETWINDOWPOSCALLBACKPROC( long* window, PositionCallback callback );
		
		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		[return: MarshalAs(UnmanagedType.FunctionPtr, MarshalTypeRef = typeof(SizeCallback))]
		public delegate SizeCallback PFNGLFWSETWINDOWSIZECALLBACKPROC( long* window, SizeCallback callback );
		
		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		[return: MarshalAs(UnmanagedType.FunctionPtr, MarshalTypeRef = typeof(WindowCallback))]
		public delegate WindowCallback PFNGLFWSETWINDOWCLOSECALLBACKPROC( long* window, WindowCallback callback );
		
		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		[return: MarshalAs(UnmanagedType.FunctionPtr, MarshalTypeRef = typeof(WindowCallback))]
		public delegate WindowCallback PFNGLFWSETWINDOWREFRESHCALLBACKPROC( long* window, WindowCallback callback );
		
		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		[return: MarshalAs(UnmanagedType.FunctionPtr, MarshalTypeRef = typeof(FocusCallback))]
		public delegate FocusCallback PFNGLFWSETWINDOWFOCUSCALLBACKPROC( long* window, FocusCallback callback );
		
		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		[return: MarshalAs(UnmanagedType.FunctionPtr, MarshalTypeRef = typeof(WindowMaximizedCallback))]
		public delegate WindowMaximizedCallback PFNGLFWSETWINDOWICONIFYCALLBACKPROC( long* window, WindowMaximizedCallback callback );
		
		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		[return: MarshalAs(UnmanagedType.FunctionPtr, MarshalTypeRef = typeof(WindowMaximizedCallback))]
		public delegate WindowMaximizedCallback PFNGLFWSETWINDOWMAXIMIZECALLBACKPROC( long* window, WindowMaximizedCallback callback );
		
		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		[return: MarshalAs(UnmanagedType.FunctionPtr, MarshalTypeRef = typeof(WindowCallback))]
		public delegate WindowCallback PFNGLFWSETFRAMEBUFFERSIZECALLBACKPROC( long* window, WindowCallback callback );
		
		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		[return: MarshalAs(UnmanagedType.FunctionPtr, MarshalTypeRef = typeof(WindowContentsScaleCallback))]
		public delegate WindowContentsScaleCallback PFNGLFWSETWINDOWCONTENTSCALECALLBACKPROC( long* window, WindowContentsScaleCallback callback );
		...
		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		public delegate int PFNGLFWGETINPUTMODEPROC( long* window, int mode );
		
		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		public delegate void PFNGLFWSETINPUTMODEPROC( long* window, int mode, int value );
		...
		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		public delegate int PFNGLFWGETKEYPROC( long* window, int key );
		
		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		public delegate int PFNGLFWGETMOUSEBUTTONPROC( long* window, int button );
		
		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		public delegate void PFNGLFWGETCURSORPOSPROC( long* window, double* xpos, double* ypos );
		
		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		public delegate void PFNGLFWSETCURSORPOSPROC( long* window, double xpos, double ypos );
		...
		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		public delegate void PFNGLFWSETCURSORPROC( long* window, Cursor cursor );
		
		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		[return: MarshalAs(UnmanagedType.FunctionPtr, MarshalTypeRef = typeof(KeyCallback))]
		public delegate KeyCallback PFNGLFWSETKEYCALLBACKPROC( long* window, KeyCallback callback );
		
		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		[return: MarshalAs(UnmanagedType.FunctionPtr, MarshalTypeRef = typeof(ErrorCallback))]
		public delegate CharCallback PFNGLFWSETCHARCALLBACKPROC( long* window, CharCallback callback );
		
		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		[return: MarshalAs(UnmanagedType.FunctionPtr, MarshalTypeRef = typeof(CharModsCallback))]
		public delegate CharModsCallback PFNGLFWSETCHARMODSCALLBACKPROC( long* window, CharModsCallback callback );
		
		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		[return: MarshalAs(UnmanagedType.FunctionPtr, MarshalTypeRef = typeof(MouseButtonCallback))]
		public delegate MouseButtonCallback PFNGLFWSETMOUSEBUTTONCALLBACKPROC( long* window, MouseButtonCallback callback );
		
		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		[return: MarshalAs(UnmanagedType.FunctionPtr, MarshalTypeRef = typeof(MouseCallback))]
		public delegate MouseCallback PFNGLFWSETCURSORPOSCALLBACKPROC( long* window, MouseCallback callback );
		
		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		[return: MarshalAs(UnmanagedType.FunctionPtr, MarshalTypeRef = typeof(MouseEnterCallback))]
		public delegate MouseEnterCallback PFNGLFWSETCURSORENTERCALLBACKPROC( long* window, MouseEnterCallback callback );
		
		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		[return: MarshalAs(UnmanagedType.FunctionPtr, MarshalTypeRef = typeof(MouseCallback))]
		public delegate MouseCallback PFNGLFWSETSCROLLCALLBACKPROC( long* window, MouseCallback callback );
		
		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		[return: MarshalAs(UnmanagedType.FunctionPtr, MarshalTypeRef = typeof(FileDropCallback))]
		public delegate FileDropCallback PFNGLFWSETDROPCALLBACKPROC( long* window, FileDropCallback callback );
		...
		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		public delegate void PFNGLFWSETCLIPBOARDSTRINGPROC( long* window, byte* @string );
		
		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		public delegate byte* PFNGLFWGETCLIPBOARDSTRINGPROC( long* window );
		...
		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		public delegate void PFNGLFWMAKECONTEXTCURRENTPROC( long* window );
		
		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		public delegate long* PFNGLFWGETCURRENTCONTEXTPROC();
		
		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		public delegate void PFNGLFWSWAPBUFFERSPROC( long* window );
